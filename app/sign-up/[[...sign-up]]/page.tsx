  ...
  return (
    <div className={styles.logoWrap} aria-hidden="true">
      <svg viewBox="0 0 80 80" className={styles.logo}>
        <defs>
          <linearGradient id="sunGridSignUpGradient" x1="16" y1="10" x2="66" y2="70">
        ...
        <circle cx="40" cy="40" r="22" fill="url(#sunGridSignUpGradient)" />
    ...
    <main className={styles.page}>
      ...
      <section className={styles.shell}>
        <div className={styles.brand}>
          <SunGridLogo />
          <h1 className={styles.name}>Create your account</h1>
          <p className={styles.tagline}>
            Start your workspace and manage real project data.
          </p>
        </div>
