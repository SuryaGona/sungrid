  ...
  return (
    <>
      ...
      >
        ...
        <section
          className="
            relative z-[1] box-border w-[min(100%,470px)] max-h-[calc(100dvh-48px)]
            rounded-[30px] border border-white/10
            bg-[linear-gradient(180deg,rgba(255,255,255,0.09),rgba(255,255,255,0.04))]
            px-[36px] py-[30px] text-center backdrop-blur-[22px]
        ...
        >
          ...
          <p
            className="
              mb-[17px] mt-0 text-[16px] font-extrabold uppercase tracking-[0.16em] text-[#D6BF76]
              max-[520px]:mb-[14px] max-[520px]:text-[15px]
              min-[521px]:max-h-[760px]:mb-[14px] min-[521px]:max-h-[760px]:text-[15px]
            "
          >
            SunGrid
          </p>
          ...
          <h1
            className="
              mx-auto m-0 max-w-[410px] text-[clamp(36px,3.65vw,40px)] font-black leading-[1] tracking-[-0.05em]
              max-[520px]:text-[38px]
              min-[521px]:max-h-[760px]:text-[38px]
            "
          >
            Turn teamwork into clear progress.
          </h1>

          <p
            className="
              mx-auto mb-0 mt-[18px] max-w-[390px] text-[15.5px] leading-[1.55] text-white/60
              max-[520px]:text-[15.5px]
              min-[521px]:max-h-[760px]:mt-[14px] min-[521px]:leading-[1.5]
            "
          >
          ...
          <div
            className="
              mt-[28px] flex flex-col gap-[13px]
              min-[521px]:max-h-[760px]:mt-6
            "
          >
            <div
              className="
            ...
            >
              <Link
                ...
                className="
                  ...
                  bg-white/[0.08] text-[15px] font-extrabold text-white/90 no-underline
            ...
            <a
              ...
              className="
                ...
                text-[15px] font-extrabold text-[#111111] no-underline
